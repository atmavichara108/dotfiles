# Generated by Powerlevel10k configuration wizard on 2026-01-31 at 22:08 MSK.
...
() {
  ...
  # quiet: глушит warning о console output при init (direnv/thefuck печатают в консоль).
  # НЕ менять обратно на verbose — иначе warning вернётся. См. фикс 6553903 в zsh/.zshrc.
